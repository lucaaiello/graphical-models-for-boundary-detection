...
saveRDS(W_true1, "RE_generation_DAGAR/W_true1.rds")
saveRDS(W_true2, "RE_generation_DAGAR/W_true2.rds")
saveRDS(W_true3, "RE_generation_DAGAR/W_true3.rds")
saveRDS(W_true4, "RE_generation_DAGAR/W_true4.rds")

saveRDS(X1, "RE_generation_DAGAR/X1.rds")
saveRDS(X2, "RE_generation_DAGAR/X2.rds")
saveRDS(X3, "RE_generation_DAGAR/X3.rds")
saveRDS(X4, "RE_generation_DAGAR/X4.rds")

saveRDS(phi_true1, "RE_generation_DAGAR/phi_true1.rds")
saveRDS(phi_true2, "RE_generation_DAGAR/phi_true2.rds")
saveRDS(phi_true3, "RE_generation_DAGAR/phi_true3.rds")
saveRDS(phi_true4, "RE_generation_DAGAR/phi_true4.rds")

saveRDS(Z1, "RE_generation_DAGAR/Z1.rds")
