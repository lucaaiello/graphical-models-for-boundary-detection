...
phi_true1 <- readRDS("RE_generation_directed_DAGAR/phi_true1.rds")
phi_true2 <- readRDS("RE_generation_directed_DAGAR/phi_true2.rds")
phi_true3 <- readRDS("RE_generation_directed_DAGAR/phi_true3.rds")
phi_true4 <- readRDS("RE_generation_directed_DAGAR/phi_true4.rds")

# spatial adjacency matrix for diseases

W_true1 <- readRDS("RE_generation_directed_DAGAR/W_true1.rds")
W_true2 <- readRDS("RE_generation_directed_DAGAR/W_true2.rds")
W_true3 <- readRDS("RE_generation_directed_DAGAR/W_true3.rds")
W_true4 <- readRDS("RE_generation_directed_DAGAR/W_true4.rds")

# covariates 

X1 <- readRDS("RE_generation_directed_DAGAR/X1.rds")
X2 <- readRDS("RE_generation_directed_DAGAR/X2.rds")
X3 <- readRDS("RE_generation_directed_DAGAR/X3.rds")
X4 <- readRDS("RE_generation_directed_DAGAR/X4.rds")

Z1 <- readRDS("RE_generation_directed_DAGAR/Z1.rds")

Y <- readRDS("RE_generation_directed_DAGAR/Y_list.rds")
...
idx <- idx[-c(11,39,42,48,54,56,57,66,80,87,90,91)]
...
for(seed in 11:100){
  ...
  filename <- paste0("runs_directed_DAGAR/mcmc_samples_", seed, ".rds")
...
spec1 <- spec1[-c(11,39,42,48,54,56,57,66,80,87,90,91),]
sens1 <- sens1[-c(11,39,42,48,54,56,57,66,80,87,90,91),]

spec2 <- spec2[-c(11,39,42,48,54,56,57,66,80,87,90,91),]
sens2 <- sens2[-c(11,39,42,48,54,56,57,66,80,87,90,91),]

spec3 <- spec3[-c(11,39,42,48,54,56,57,66,80,87,90,91),]
sens3 <- sens3[-c(11,39,42,48,54,56,57,66,80,87,90,91),]

spec4 <- spec4[-c(11,39,42,48,54,56,57,66,80,87,90,91),]
sens4 <- sens4[-c(11,39,42,48,54,56,57,66,80,87,90,91),]
...
specW1 <- specW1[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]
sensW1 <- sensW1[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]

specW2 <- specW2[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]
sensW2 <- sensW2[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]

specW3 <- specW3[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]
sensW3 <- sensW3[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]

specW4 <- specW4[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]
sensW4 <- sensW4[-c(11,39,42,48,54,56,57,66,80,87,90,91,97)]
...
saveRDS(WAIC, file = "WAIC_directed.rds")
