...
phi_true1 <- readRDS("RE_generation_undirected_DAGAR/phi_true1.rds")
phi_true2 <- readRDS("RE_generation_undirected_DAGAR/phi_true2.rds")
phi_true3 <- readRDS("RE_generation_undirected_DAGAR/phi_true3.rds")
phi_true4 <- readRDS("RE_generation_undirected_DAGAR/phi_true4.rds")

# spatial adjacency matrix for diseases

W_true1 <- readRDS("RE_generation_undirected_DAGAR/W_true1.rds")
W_true2 <- readRDS("RE_generation_undirected_DAGAR/W_true2.rds")
W_true3 <- readRDS("RE_generation_undirected_DAGAR/W_true3.rds")
W_true4 <- readRDS("RE_generation_undirected_DAGAR/W_true4.rds")

# covariates 

X1 <- readRDS("RE_generation_undirected_DAGAR/X1.rds")
X2 <- readRDS("RE_generation_undirected_DAGAR/X2.rds")
X3 <- readRDS("RE_generation_undirected_DAGAR/X3.rds")
X4 <- readRDS("RE_generation_undirected_DAGAR/X4.rds")

Z1 <- readRDS("RE_generation_undirected_DAGAR/Z1.rds")

Y <- readRDS("RE_generation_undirected_DAGAR/Y_list.rds")
...
idx <- idx[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97)]
...
for(seed in 1:100){
  ...
  filename <- paste0("runs_DAGAR/mcmc_undirected_samples_", seed, ".rds")
...
spec1 <- spec1[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]
sens1 <- sens1[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]

spec2 <- spec2[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]
sens2 <- sens2[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]

spec3 <- spec3[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]
sens3 <- sens3[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]

spec4 <- spec4[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]
sens4 <- sens4[-c(11,25,32,56,57,60,61,66,69,82,85,87,90,97),]
...
specW1 <- specW1[-c(11,54)]
sensW1 <- sensW1[-c(11,54)]

specW2 <- specW2[-c(11,54)]
sensW2 <- sensW2[-c(11,54)]

specW3 <- specW3[-c(11,54)]
sensW3 <- sensW3[-c(11,54)]

specW4 <- specW4[-c(11,54)]
sensW4 <- sensW4[-c(11,54)]
...
saveRDS(WAIC, file = "WAIC_undirected.rds")
