...
phi_true1 <- readRDS("CAR/RE_generation_undirected_CAR/phi_true1.rds")
phi_true2 <- readRDS("CAR/RE_generation_undirected_CAR/phi_true2.rds")
phi_true3 <- readRDS("CAR/RE_generation_undirected_CAR/phi_true3.rds")
phi_true4 <- readRDS("CAR/RE_generation_undirected_CAR/phi_true4.rds")

# spatial adjacency matrix for diseases

W_true1 <- readRDS("CAR/RE_generation_undirected_CAR/W_true1.rds")
W_true2 <- readRDS("CAR/RE_generation_undirected_CAR/W_true2.rds")
W_true3 <- readRDS("CAR/RE_generation_undirected_CAR/W_true3.rds")
W_true4 <- readRDS("CAR/RE_generation_undirected_CAR/W_true4.rds")

# covariates 

X1 <- readRDS("CAR/RE_generation_undirected_CAR/X1.rds")
X2 <- readRDS("CAR/RE_generation_undirected_CAR/X2.rds")
X3 <- readRDS("CAR/RE_generation_undirected_CAR/X3.rds")
X4 <- readRDS("CAR/RE_generation_undirected_CAR/X4.rds")

Z1 <- readRDS("CAR/RE_generation_undirected_CAR/Z1.rds")

Y <- readRDS("CAR/RE_generation_undirected_CAR/Y_list.rds")
...
saveRDS(WAIC, file = "CAR/WAIC_undirected.rds")
