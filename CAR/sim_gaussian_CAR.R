...
sourceCpp('CAR/sampler_sim_gaussian_CAR_fastest.cpp')
...
for(seed in 1:100){
  ...
  filename <- paste0("CAR/runs_CAR/mcmc_samples_", seed, ".rds")
  saveRDS(mcmc_samples, file = filename)
  
}

saveRDS(W_true1, "CAR/RE_generation_CAR/W_true1.rds")
saveRDS(W_true2, "CAR/RE_generation_CAR/W_true2.rds")
saveRDS(W_true3, "CAR/RE_generation_CAR/W_true3.rds")
saveRDS(W_true4, "CAR/RE_generation_CAR/W_true4.rds")

saveRDS(X1, "CAR/RE_generation_CAR/X1.rds")
saveRDS(X2, "CAR/RE_generation_CAR/X2.rds")
saveRDS(X3, "CAR/RE_generation_CAR/X3.rds")
saveRDS(X4, "CAR/RE_generation_CAR/X4.rds")

saveRDS(phi_true1, "CAR/RE_generation_CAR/phi_true1.rds")
saveRDS(phi_true2, "CAR/RE_generation_CAR/phi_true2.rds")
saveRDS(phi_true3, "CAR/RE_generation_CAR/phi_true3.rds")
saveRDS(phi_true4, "CAR/RE_generation_CAR/phi_true4.rds")

saveRDS(Z1, "CAR/RE_generation_CAR/Z1.rds")

saveRDS(Y_list, "CAR/RE_generation_CAR/Y_list.rds")
