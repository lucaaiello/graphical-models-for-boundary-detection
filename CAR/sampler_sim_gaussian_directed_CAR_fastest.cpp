...
List MADAGAR(const arma::vec& y, const arma::mat& X, const arma::mat& Z1,
  ...
  double r_dens = ldmvnorm(n, q, r, A, W_dis, Q);
  ...
  for (int iter = 0; iter < iterations; iter++) {
    ...
    for (int id = 0; id < nq; id++) {
      ...
      double pro_r_dens = ldmvnorm(n, q, pro_r, A, W_dis, Q);
    ...
    // 
    // double pro_r_dens = ldmvnorm(n, q, r, A, pro_Q);
    // 
    ...
    double pro_r_dens = ldmvnorm(n, q, r, A, W_dis, pro_Q);
    ...
    r_dens = ldmvnorm(n, q, r, A, W_dis, Q);
