...
W_dis_dir <- cbind(c(0,1,0,1),c(0,0,1,0),c(0,0,0,1),c(0,0,0,0))
...
sourceCpp('Misspecified models/sampler_sim_gaussian_directed_DAGAR_fastest.cpp')
...
for(seed in 1:100){
  ...
  mcmc_samples <- MADAGAR(y=Y, X=X, Z1=Z1,
                          q=4, Minc=Minc, W_dis = W_dis_dir,
                          alpha=1, n_atoms=15,
                          runs=10000, burn=10000, thin=1)

  toc()

  filename <- paste0("Misspecified models/Undirected/Directed/runs_directed_DAGAR/mcmc_samples_", seed, ".rds")
  saveRDS(mcmc_samples, file = filename)
  
}

saveRDS(W_true1, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true1.rds")
saveRDS(W_true2, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true2.rds")
saveRDS(W_true3, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true3.rds")
saveRDS(W_true4, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true4.rds")

saveRDS(W_dis, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_dis.rds")

saveRDS(Vr, file = "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/Vr_true.rds")

saveRDS(X1, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X1.rds")
saveRDS(X2, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X2.rds")
saveRDS(X3, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X3.rds")
saveRDS(X4, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X4.rds")

saveRDS(phi_true1, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true1.rds")
saveRDS(phi_true2, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true2.rds")
saveRDS(phi_true3, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true3.rds")
saveRDS(phi_true4, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true4.rds")

saveRDS(Z1, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/Z1.rds")

saveRDS(Y_list, "Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/Y_list.rds")
