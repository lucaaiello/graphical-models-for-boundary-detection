...
phi_true1 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true1.rds")
phi_true2 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true2.rds")
phi_true3 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true3.rds")
phi_true4 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/phi_true4.rds")

# spatial adjacency matrix for diseases

W_true1 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true1.rds")
W_true2 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true2.rds")
W_true3 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true3.rds")
W_true4 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/W_true4.rds")

# covariates 

X1 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X1.rds")
X2 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X2.rds")
X3 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X3.rds")
X4 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/X4.rds")

Z1 <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/Z1.rds")

Y <- readRDS("Misspecified models/Undirected/Directed/RE_generation_directed_DAGAR/Y_list.rds")
...
saveRDS(WAIC, file = "Misspecified models/Undirected/Directed/WAIC_undirected_directed.rds")
