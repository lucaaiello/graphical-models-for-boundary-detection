...
WAIC_unstructured <- readRDS("WAIC/WAIC_unstructured_unstructured.rds")
WAIC_directed <- readRDS("WAIC/WAIC_directed_directed.rds")
WAIC_undirected <- readRDS("WAIC/WAIC_undirected_undirected.rds")
