...
saveRDS(W_true1, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/W_true1.rds")
saveRDS(W_true2, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/W_true2.rds")
saveRDS(W_true3, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/W_true3.rds")
saveRDS(W_true4, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/W_true4.rds")

saveRDS(Vr, file = "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/Vr_true.rds")

saveRDS(X1, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/X1.rds")
saveRDS(X2, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/X2.rds")
saveRDS(X3, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/X3.rds")
saveRDS(X4, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/X4.rds")

saveRDS(phi_true1, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/phi_true1.rds")
saveRDS(phi_true2, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/phi_true2.rds")
saveRDS(phi_true3, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/phi_true3.rds")
saveRDS(phi_true4, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/phi_true4.rds")

saveRDS(Z1, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/Z1.rds")

saveRDS(Y_list, "Misspecified models/Unstructured/Undirected/RE_generation_undirected_DAGAR/Y_list.rds")